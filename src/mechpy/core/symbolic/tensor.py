...
Classes:
    `SymbolicTensor <#mechpy.core.symbolic.tensor.SymbolicTensor>`_:
        A base class for symbolic tensors. It handles initialization with SymPy Matrix objects and provides basic tensor properties and operations, including checks for symmetry and shape.
    ...
    `SymbolicSixBySixTensor <#mechpy.core.symbolic.tensor.SymbolicSixBySixTensor>`_:
        Extends SymbolicTensor for 6x6 symbolic tensors. Includes specific functionalities for working with 6x6 tensor matrices.
